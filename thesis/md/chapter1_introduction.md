...
第二章为相关技术，围绕项目实现所依赖的关键方法展开介绍，重点分析检索增强生成、大语言模型、语音识别、语音合成、实时通信与异步并发等技术的基本原理及其适用性，为后续系统设计提供理论基础。
...
第七章为结论与展望，对全文工作进行总结，并在此基础上分析当前项目仍然存在的不足，进一步讨论后续在知识库扩展、检索优化、交互能力提升和工程落地等方面的改进方向。
